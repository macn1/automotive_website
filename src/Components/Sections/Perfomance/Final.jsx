...
export default function PaintHero() {
    ...
    return (
        ...
        >
            {/* Background Image */}
            <motion.img
                src="/assets/perfomance/img7.jpg"
                alt="Car performance service"
            ...
            >
                ...
                >
                    Whether you want sharper throttle response or a full performance transformation, our team is ready to engineer your next upgrade.
                </motion.p>
                ...
                <motion.button
                    ...
                    whileHover="hover"
                    whileTap="tap"
                    className="mt-3 bg-red-600 text-white text-sm font-medium px-6 py-2.5 rounded-sm tracking-wide transition-colors duration-200"
                >
